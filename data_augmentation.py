...
def change_xml_list_annotation(root, image_id, new_target, saveroot, id,img_name):
    ...
    elem.text = (img_name + str("_%06d" % int(id)) + '.png')
    xmlroot = tree.getroot()
    index = 0
...
if __name__ == "__main__":
    ...
    IMG_DIR = "/home/touchair/cv/detect_tv_phone_soundX/data_add_1111/images"
    XML_DIR = "/home/touchair/cv/detect_tv_phone_soundX/data_add_1111/labels"

# =============================================================================
#     AUG_XML_DIR = "./Annotations"  # 存储增强后的XML文件夹路径
# =============================================================================
    AUG_XML_DIR = "/home/touchair/cv/detect_tv_phone_soundX/data_augmentation_v6/labels"  # 存储增强后的XML文件夹路径
    try:
...
# =============================================================================
    AUG_IMG_DIR = "/home/touchair/cv/detect_tv_phone_soundX/data_augmentation_v6/images"  # 存储增强后的影像文件夹路径
    try:
